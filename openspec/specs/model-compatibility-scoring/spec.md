...
Enable users to track and manage LLM model compatibility scores for prompts. Store model identifiers as text to facilitate future integration with a Model Management collection, allowing users to specify which models work best with each prompt.
